...
lprint("");
lprint("");
lprint("This Maple Package is implemented by Erdal Imamoglu <eimamoglu@klu.edu.tr>");
lprint("");
lprint("This package contains procedures to write a given polynomial f in terms of Chebyshev Polynomials of the 1st and 2nd Kind, and in terms of Dickson Polynomials of the 1st and 2nd Kind.");
lprint("");
lprint("References");
